...
TEXTE = {
    ...
    's_dk_morkhan_bugs': ('Dazu die beiden Funde vom 28.08.: dass eine Mission '
                          ...
                          'im Titel. Sein hartnäckigster Fund: dass ein Auftrag mit mehreren Preisstufen nur die Baupläne EINER Stufe zeigte — daran hingen 797 Baupläne, die niemand je zu sehen bekam. Außerdem: das Update über das Infofenster, das nie ankam '
                          ...
                          'His most persistent find: a contract with several payout tiers only showed the blueprints of ONE tier — 797 blueprints hung on that, and nobody ever saw them. '
