...
TEXTE = {
    ...
    's_ov_modus_h':    ('Dauerhaft sichtbar, oder nur kurz aufblenden, wenn ein Bauplan dazukommt. Im Aufblend-Betrieb holst du es zurück, indem du das Programm noch einmal startest — auf die Verknüpfung lässt sich eine Tastenkombination legen.',
                          'Permanently visible, or briefly popping up when a blueprint arrives. In pop-up mode you bring it back by starting the program again — you can put a keyboard shortcut on the shortcut.'),
