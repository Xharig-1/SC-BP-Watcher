...
| <img src="assets/symbole/22/joysticks-gruen.png" width="22" alt=""> **Joysticks & Tastatur** | **Was liegt auf welcher Taste?** Die komplette Belegung im Klartext — „Schleudersitz" statt `v_eject`, in der Sprache des Werkzeugs. Joystick, Tastatur, Maus und Gamepad in einer durchsuchbaren Liste, umschaltbar zwischen *von mir geändert*, *alles* und *Werkseinstellung*. Dazu: welcher Stick welche Nummer hat und ob deine Belegung noch auf ein angeschlossenes Gerät zeigt; meldet sich ein Stick unter neuer Kennung, lässt sich seine alte Belegung auf Knopfdruck übernehmen (mit Sicherung). Funktioniert für **jedes** Gerät — es muss nichts vorher eingepflegt werden |
