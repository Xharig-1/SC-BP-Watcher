...
| <img src="assets/symbole/22/joysticks-gruen.png" width="22" alt=""> **Joysticks** | Welcher Stick welche Nummer hat (`js1`, `js2` …), ob deine Belegung noch auf ein Gerät zeigt, das wirklich angeschlossen ist — und **was auf welchem Knopf liegt**, durchsuchbar und nach Gerät filterbar. Meldet sich ein Stick unter neuer Kennung, weil er an einem anderen Anschluss steckt, lässt sich seine alte Belegung auf Knopfdruck übernehmen (mit Sicherung). Funktioniert für **jeden** Stick, jedes Pedal, jedes Gamepad — es muss nichts vorher eingepflegt werden |
